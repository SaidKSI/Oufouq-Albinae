        ...
        <thead>
          <tr class="text-uppercase text-start">
            ...
            <th
              ...
              Mode Reglement</th>
            <th class="text-start"
              style="background: rgba(255,255,255,0);border: 2px solid rgb(0,0,0) ;border-bottom-style: none;">oro patis
            </th>
          </tr>
        </thead>
        <tbody>
          <tr class="text-uppercase text-start">
            ...
            <td style="background: rgba(255,255,255,0);border: 2px solid rgb(0,0,0) ;border-top-style: none;">
              {{$estimate->transaction_id}} </td>
            <td class="text-start"
              style="background: rgba(255,255,255,0);border: 2px solid rgb(0,0,0) ;border-top-style: none;">ice
              {{$estimate->project->client->ice}}</td>
          </tr>
        </tbody>
      </table>
    </div>
      ...
      <table class="table table-sm table-borderless">
        ...
        <tbody>
          <tr>
            ...
            <th class="border-2 border-dark" style="background: rgba(255,255,255,0);height: 500px;">{{ number_format($total,2)}}</th>
          </tr>
          <tr>
            <th class="text-capitalize border-2 border-dark" style="background: rgba(255,255,255,0);" colspan="2"
              rowspan="2">Arreté La présente facture à la somme de :<br>#... {{$total_in_alphabetic}} Dirhams...#</th>
