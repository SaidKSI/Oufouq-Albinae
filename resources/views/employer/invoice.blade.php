...
<head>
    <meta charset="utf-8" />
    <title>Employer invoice - {{$payment->employee->full_name}}</title>
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                Invoice #: {{$payment->payment_id}}<br />
                                Created: {{$payment->created_at->format('d M Y')}}<br />
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                {{$payment->employee->full_name}}.<br />
                                {{$payment->employee->profession->name}}<br />
